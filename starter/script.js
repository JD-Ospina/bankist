...
//Rounding decimals (Returns a string)
console.log((2.7).toFixed(0)); //3 - No decimals
...
/*
///////////////////////////////////////////////////////////
//Numeric Separators: Format numbers in a way that is easier to read and understand
...
console.log(new Date('Thu May 05 2022 11:44:12'));
console.log(new Date('December 24, 2022'));
console.log(new Date(account1.movementsDates[0]));

console.log(new Date(2037, 10, 19, 15, 23, 5)); //Months are 0 based
console.log(new Date(2037, 10, 31)); //Correts mistakes
...
console.log('Colombia: ', new Intl.NumberFormat('es-CO', options).format(num));
console.log(
  navigator.language,
...
//setTimeout -> Function is called once
